...
5. Нажатием кнопки **"+"** прописать ключи переменных аналогично скриншоту, а значения заменить **соответствующими параметрами Вашей БД**.
