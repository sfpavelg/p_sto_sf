...
@Sql(value = {"/datasets/example-create.sql"}, executionPhase = Sql.ExecutionPhase.BEFORE_TEST_METHOD)
@Sql(value = {"/datasets/example-drop.sql"}, executionPhase = Sql.ExecutionPhase.AFTER_TEST_METHOD)
