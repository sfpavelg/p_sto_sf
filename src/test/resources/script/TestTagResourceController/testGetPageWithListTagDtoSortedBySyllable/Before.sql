...
VALUES (100, 'description100', 'name1', CURRENT_TIMESTAMP - INTERVAL '9 days'),
       ...
       (103, 'description103', 'name4', CURRENT_TIMESTAMP - INTERVAL '6 days'),
       (104, 'description104', 'name51', CURRENT_TIMESTAMP - INTERVAL '5 days'),
       (105, 'description105', 'name62', CURRENT_TIMESTAMP - INTERVAL '4 days'),
       (106, 'description106', 'name73', CURRENT_TIMESTAMP - INTERVAL '3 days'),
       (107, 'description107', 'name84', CURRENT_TIMESTAMP - INTERVAL '2 days'),
       (108, 'description108', 'name95', CURRENT_TIMESTAMP - INTERVAL '1 days');
