DELETE FROM reputation where id BETWEEN 1 and 5;
...
DELETE FROM question where id BETWEEN 1 and 5;

DELETE FROM user_entity where id BETWEEN 1 and 5;

DELETE FROM tag where id BETWEEN 1 and 10;
